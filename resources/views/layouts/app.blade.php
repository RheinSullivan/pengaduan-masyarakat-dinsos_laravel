            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        <li>
                            <a
                                class="nav-link scrollto {{ request()->is("/pengaduan") ? "active" : "" }}"
                        ...
                        <li>
                            <a
                                class="nav-link scrollto {{ request()->is("pengaduan.laporan") ? "active" : "" }}"
                                href="{{ route("pengaduan.laporan", "saya") }}"
                            >
                                Pengaduan Saya
                            </a>
                        </li>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-3 col-md-6 footer-contact">
                            ...
                            <p>
                                ...
                                kenyamanan kepada masyarakat dalam menyampaikan
                                pengaduan terkait layanan sosial, dengan proses
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <ul>
                                <p>
                                    ...
                                    <a
                                        href="https://goo.gl/maps/fMkWmHFLFq27mRwh7"
                                        target="_blank"
                                        rel="nofollow"
                                    >
                                        Jl. Sunan Drajat No. 16, Sumber
                                        <br />
                                        Kec. Sumber, Kab. Cirebon Jawa Barat
                                        45611
                                    </a>
                                    <br />
                                    <strong>Phone:</strong>
                                    <a href="tel:+(0231) 321208">
                                        (0231)321208
                                    </a>
                                    <br />
                                    <strong>Email:</strong>
                                    <a href="mailto:dinsos@cirebonkab.go.id">
                                        dinsos@cirebonkab.go.id
                                    </a>
                                    <br />
                                </p>
                            </ul>
                ...
                <div class="me-md-auto my-auto text-center text-md-start">
                    <div class="copyright">
                        ...
                        <strong>
                            <span>
                                <a
                                    href="https://sipepeg.cirebonkab.go.id/"
                                    target="_blank"
                                >
                                    Dinas Sosial
                                </a>
