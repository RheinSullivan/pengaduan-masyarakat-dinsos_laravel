                                ...
                                <tbody>
                                    @foreach ($pengaduan as $k => $i)
                                        <tr>
                                            <td>{{ $k += 1 }}.</td>
                                            <td>
                                                {{ Carbon\Carbon::parse($i->tgl_pengaduan)->format("d-m-Y") }}
                                            </td>
                                            <td>{{ $i->user->name }}</td>
                                            <td>{{ $i->judul_laporan }}</td>
                                            <td>
                                                {{ \Illuminate\Support\Str::limit($i->isi_laporan, 30, "...") }}
                                            </td>
                                            <td>
                                                {{ Carbon\Carbon::parse($i->tgl_kejadian)->format("d-m-Y") }}
                                            </td>
